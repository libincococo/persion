...
src_base = os.path.join("/media/sky/8C6C1B5A6C1B3E80/dataset/", "coco", "annotations")
dst_base = os.path.join("/media/sky/8C6C1B5A6C1B3E80/dataset/coco", "VOCdevkitCOCO", "VOCCOCOTRAIN")
