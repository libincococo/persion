...
transform_train = transforms.Compose([
    ...
    #transforms.ColorJitter(brightness=(0,0.15),contrast=(0,0.15),saturation=0,hue=0),
    transforms.ToTensor(),
...
'''
trainset = persiondataset('train.cvs','/media/sky/8C6C1B5A6C1B3E80/dataset/DTA_Person',transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True, num_workers=8)

testset = persiondataset('test.cvs','/media/sky/8C6C1B5A6C1B3E80/dataset/DTA_Person',transform=transform_test)
